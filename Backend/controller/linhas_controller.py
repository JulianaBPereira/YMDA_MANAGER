...
from ..Services.linhas_service import LinhaService, LinhaCompostaService
from ..Database.database import get_db
from ..DAO.linhas_dao import LinhasDAO, SublinhasDAO
from ..Schema.linhaSchema import LinhaCreate, LinhaUpdate, LinhaResponse, LinhaComSublinhaCreate
...
def criar(body: LinhaCreate, db: Session = Depends(get_db)):
    service = LinhaService(LinhasDAO(db))
    try:
        return service.criar_linha(body.nome)
